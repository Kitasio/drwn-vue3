    ...
    <div class="h-screen  p-5 sm:p-10 lg:px-32 mx-auto">
        <div class="font-ttnorms relative rounded-lg shadow-brand p-5 lg:p-10 w-full h-5/6  overflow-scroll">
            <div class="flex justify-between items-center">
                <div class="text-2xl mb-5 font-benzin-semibold">Добавление Сектора</div>
                <button class="px-5 py-2 border-2 rounded-md cursor-pointer transition duration-200 hover:bg-deep-green hover:text-white border-deep-green text-deep-green" @click="addSector(); router.go(-1)">Сохранить</button>
            </div>
...
const { sector, addSector } = sectorFuncs()
