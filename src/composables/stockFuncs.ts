...
const stockFuncs = () => {
    ...
    const addStock = () => {
        db.collection("stocks").add({
            ...
            adx: stock.value.adx,
            highLowsDiff: stock.value.highLowsDiff,
            smaEmaDiff: stock.value.smaEmaDiff,
            accumDiff: stock.value.accumDiff,
            adxDiff: stock.value.adxDiff,
            fwd: stock.value.fwd,
            debtEquity: stock.value.debtEquity,
            currentRatio: stock.value.currentRatio,
            openInterest: stock.value.openInterest,
            analysts: stock.value.analysts,
